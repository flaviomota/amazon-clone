			...
			<div class="relative -mt-[300px]">
				<div class="flex m-4 z-10 relative">
					<div class="bg-white mx-2 p-2 text-md w-full text-center">
						You are on amazon.com. You can also shop on Amazon Portugal for millions of products with fast local delivery.
						<span class="underline text-teal-600 cursor-pointer">Click here to go to amazon.es</span>
					</div>
				</div>
				...
				<div class="grid grid-cols-3 m-4 z-10 relative">
					<div class="p-1.5 flex">
						<div class="bg-white p-5">
							...
							<div class="flex">
								<img class="object-fill" src="https://via.placeholder.com/1097x756" />
							</div>
